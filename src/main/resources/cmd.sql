...
password varchar(100), w_id integer references wallet(w_id), user_name varchar(200));
...
driver_id integer references user(u_id),v_id integer references vehicle(v_id), source varchar(100),destination varchar(100),
ride_date datetime, created_date datetime, cost_per_person integer,seats_available integer); 
...
insert into wallet values(5,200);

insert into user values(1, 'a@a.com', 'a', 1,'a');
insert into user values(2, 'b@a.com', 'b', 2,'b');
insert into user values(3, 'c@a.com', 'c', 3,'c');
insert into user values(4, 'd@a.com', 'd', 4,'d');
insert into user values(5, 'abhinav071197@gmail.com', 'abhinav', 5, 'abhinav');
...
insert into ride values(5, 5,1,'himayathnagar','gachibowli','2019-01-11 10:50:00', '2019-01-11 10:00:00',100,4);


insert into user_ride values(1, 2,'requested',2,'2019-01-11 12:00:00','2019-01-11 12:00:00');
insert into user_ride values(1, 3,'accepted',3,'2019-01-11 12:00:00','2019-01-11 10:00:00');
insert into user_ride values(1, 4,'accepted',4,'2019-01-11 12:00:00','2019-01-11 10:00:00');
insert into user_ride values(1, 4,'rejected',4,'2019-01-11 12:00:00','2019-01-11 12:00:00');